...
<html lang="pt-br">
    ...
    <body>
        ...
        testee existe notificacao nao lida
            <div class="notificacao" title="Você possui notificações não lidas!" onclick="window.location.href='https://bandejapp.herokuapp.com/user/avisos'">a</div>
        @endforeach
