...
<html lang="pt-br">
    ...
    <body>
        ...
        @if(session()->has('message'))
            <div class="alert alert-success msg-confirmacao opacity-50" style="text-align: center; position: fixed !important; z-index: 1; width: 100% !important; opacity: 0.5; !important;">
                {{ session()->get('message') }}
            </div>
        @endif
        <br>
